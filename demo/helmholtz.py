...
from minidolfin.petsc import create_matrix_from_csr, create_scalar
...
# Build sparsity pattern and create tensors
...
assemble(A, [dofmap, dofmap], a, form_compiler_parameters)
t += timeit.default_timer()
print('Assembly time a: {}'.format(t))

# Assemble right-hand side
t = -timeit.default_timer()
assemble(b, [dofmap], L, form_compiler_parameters)
t += timeit.default_timer()
